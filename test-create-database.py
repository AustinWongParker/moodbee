...
CREATE_USR_LOGIN_TABLE = ("CREATE TABLE IF NOT EXISTS test_user_credential_table (user_id, username, email, password)")
CREATE_USR_MOOD_TABLE = ("CREATE TABLE IF NOT EXISTS test_mood_table (emotion_id, user_id, selectedImage, comment, date)")
